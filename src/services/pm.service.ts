...
import type { PMsByAccountsQuery, PMScheduleDetail } from "../types/dtos/pm.dto"
import { flattenObject } from "../utils/flatten"

export class PmService {
  async getPMsByAccounts(query: PMsByAccountsQuery) {
  ...
  async getPMScheduleDetail(pmScheduleId: number): Promise<PMScheduleDetail> {
    ...
    return flat as PMScheduleDetail
  }
}
