...
const getPMsByAccounts = async (req, res) => {
    try {
        ...
        return (0, responseUtils_1.sendPaginatedResponse)(res, flattenedTransformed, totalUnits, page, perPage, 200, {
            counts: {
                totalUnits,
                unitsComingDue,
                unitsOverdue,
...
const getPMScheduleDetail = async (req, res) => {
    try {
        ...
        return (0, responseUtils_1.sendSuccessResponse)(res, flat);
    }
    catch (error) {
